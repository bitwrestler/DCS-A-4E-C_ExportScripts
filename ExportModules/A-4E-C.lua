...
ExportScript.ConfigArguments = 
{
	...
	[744] = "%.2f",  -- AWRS Mode Selector Switch (Device WEAPON_SYSTEM/6 Command/Button 3034 ID 744 Increment -0.1 Range 0-0.5)
	[702] = "%1d",  -- Bomb Arm Switch (Device WEAPON_SYSTEM/6 Command/Button 3026 ID 702 Increment -1 Range -1-1)
	[726] = "%1d",  -- Shrike/Sidewinder Volume Knob (Device WEAPON_SYSTEM/6 Command/Button 3125 ID 726 Increment 0 Range -1.0-1.0)
	...
	[742] = "%1d",  -- AWRS Drop Interval Knob (Device WEAPON_SYSTEM/6 Command/Button 3032 ID 742 Increment 0 Range 0-0.9)
	[1241] = "%1d",  -- Emergency Stores Release Handle (Device WEAPON_SYSTEM/6 Command/Button 3027 ID 1241 Increment 1 Range 0-1)
	[708] = "%.2f",  -- Weapon Function Selector Switch (Device WEAPON_SYSTEM/6 Command/Button 3008 ID 708 Increment -0.1 Range 0-0.6)
	...
	[700] = "%.2f",  -- Emergency Release Selector (Device WEAPON_SYSTEM/6 Command/Button 3025 ID 700 Increment -0.1 Range 0-0.6)
	[706] = "%1d",  -- Station 4 Selector Switch (Device WEAPON_SYSTEM/6 Command/Button 3006 ID 706 Increment 1 Range 0-1)
	[725] = "%.2f",  -- Shrike Selector Knob (Device WEAPON_SYSTEM/6 Command/Button 3137 ID 725 Increment -0.1 Range 0-0.4)
	...
	[120] = "%.2f",  -- AN/APG-53A Radar Mode Switch (Device RADAR/10 Command/Button 3063 ID 120 Increment -0.1 Range 0-0.4)
	[721] = "%1d",  -- Radar Terrain Clearance Switch (Device RADAR/10 Command/Button 3055 ID 721 Increment 1 Range 0-1)
	[401] = "%1d",  -- Radar Indicator Brilliance (Device RADAR/10 Command/Button 3058 ID 401 Increment 0.0 Range 0-1)
	[122] = "%.2f",  -- Radar Antenna Tilt Switch (Device RADAR/10 Command/Button 3065 ID 122 Increment 0.4 Range 0-1)
	[404] = "%1d",  -- Radar Indicator Reticle (Device RADAR/10 Command/Button 3062 ID 404 Increment 0.0 Range 0-1)
	[121] = "%1d",  -- Radar AoA Compensation Switch (Device RADAR/10 Command/Button 3064 ID 121 Increment 1 Range 0-1)
	[400] = "%1d",  -- Radar Indicator Storage (Device RADAR/10 Command/Button 3057 ID 400 Increment 0.0 Range 0-1)
	[722] = "%1d",  -- Radar Range Switch (Device RADAR/10 Command/Button 3056 ID 722 Increment 1 Range 0-1)
	[403] = "%1d",  -- Radar Indicator Gain (Device RADAR/10 Command/Button 3060 ID 403 Increment 0.0 Range 0-1)
	[405] = "%1d",  -- Radar Indicator Filter Plate (Device RADAR/10 Command/Button 3061 ID 405 Increment 1 Range 0-1)
	[402] = "%1d",  -- Radar Indicator Detail (Device RADAR/10 Command/Button 3059 ID 402 Increment 0.0 Range 0-1)
	[123] = "%1d",  -- Radar Obstacle Tone Volume (Device RADAR/10 Command/Button 3068 ID 123 Increment 0.0 Range -1-1)
