...
[106] = "%1d",  -- Instrument Lights Control (Device AVIONICS/2 Command/Button intlight_instruments/3082 ID PNT_106/106 Increment 0.0 Range 0-1)
[107] = "%1d",  -- Console Lights Control (Device AVIONICS/2 Command/Button intlight_console/3083 ID PNT_107/107 Increment 0.0 Range 0-1)
...
[110] = "%1d",  -- White Floodlights Control (Device AVIONICS/2 Command/Button intlight_whiteflood/3081 ID PNT_110/110 Increment 0.0 Range 0-1)
...
[170] = "%.2f",  -- AN/APN-153 Doppler Navigation Radar Mode Switch (Device NAV/23 Command/Button doppler_select/3045 ID PNT_170/170 Increment -0.1 Range 0-0.4)
[176] = "%.2f",  -- AN/ASN-41 Function Selector Switch (Device NAV/23 Command/Button nav_select/3047 ID PNT_176/176 Increment -0.1 Range 0-0.4)
...
[524] = "%1d",  -- Dispenser 1 Counter (Device COUNTERMEASURES/32 Command/Button cm_adj1/3108 ID PNT_524/524 Increment 0.0 Range 0-1)
[525] = "%1d",  -- Dispenser 2 Counter (Device COUNTERMEASURES/32 Command/Button cm_adj2/3109 ID PNT_525/525 Increment 0.0 Range 0-1)
...
[892] = "%1d",  -- Gunsight Elevation Control (Device GUNSIGHT/22 Command/Button GunsightKnob/3028 ID PNT_892/892 Increment 1.0 Range 0-1)
[895] = "%1d",  -- Gunsight Light Control (Device GUNSIGHT/22 Command/Button GunsightBrightness/3030 ID PNT_895/895 Increment 0 Range 0-1)
